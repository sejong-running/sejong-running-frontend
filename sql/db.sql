...
Table courses {
  ...
  min_latitude decimal(10,8) [not null, note: '경로 전체 중 최소 위도']
  min_longitude decimal(11,8) [not null, note: '경로 전체 중 최소 경도']
  max_latitude decimal(10,8) [not null, note: '경로 전체 중 최대 위도']
  max_longitude decimal(11,8) [not null, note: '경로 전체 중 최대 경도']
